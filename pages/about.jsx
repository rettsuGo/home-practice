    ...
    return (
        <>
          ...
          <div className=" w-full flex">
              <Image src="/store1.jpg " width="450" height={400} alt="画像"/>
              <Image src="/store2.jpg " width="450" height={400} alt="画像"/>
              <Image src="/store3.jpg " width="450" height={400} alt="画像"/>
              <Image src="/store4.jpg " width="450" height={400} alt="画像"/>
          </div>
